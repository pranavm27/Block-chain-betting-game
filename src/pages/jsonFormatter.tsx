...
const component = () => {
      ...
      return (
        <div className="relative pt-1 flex flex-row">
          <textarea
            id="message"
            rows={15}
            className="block m-3 p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-red-700 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Enter Text Here ..."
            value={error}
          ></textarea>
        </div>
  ...
  const [value, setValue] = useState('{"name":"John", "age":30, "car":null}');
        ...
        >
          ...
          <div className="relative pt-1 flex flex-row">
            <textarea
              id="message"
              rows={15}
              defaultValue='{"name":"John", "age":30, "car":null}'
